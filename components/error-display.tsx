...
const ErrorDisplayComponent = memo(function ErrorDisplayComponent({
  translationError,
  speechError,
  isSpeechSupported,
  isTTSSupported,
    ...
    <>
      ...
      {!isTTSSupported && (
        <Alert className="mb-6 animate-scale-in">
          <AlertCircle className="h-4 w-4" />
          <AlertDescription>
            Text-to-speech is not supported in this browser. Audio playback will
            not be available.
          </AlertDescription>
        </Alert>
      )}
...
export const ErrorDisplay = ErrorDisplayComponent;
